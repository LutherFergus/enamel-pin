...
- Enamel mock outline path (elephant Org→Outline): extracts **black hatch + morphological edges of gold dams**, not filled gold blobs and not color-cell boundaries. Dark studio backdrops are flood-cleared from the frame (not blanket-thresholded). Defaults: `sensitivity: 70`, `thickness: 2`, `colorCount: 14`, `maxDim: 2000`.
